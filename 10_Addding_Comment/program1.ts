// QUESTION NO 10: Adding Comments: Choose two of the programs you’ve written, and add at least one
...
//let name:string="Zakheer Ali";
//let date:number=25;
//in this program we will write Hello world.
