...
var new_users = ["ali", "TaHa", "dilsher", "jameel", "Hamzah"];
new_users.forEach(function (newusername) {
    ...
    if (current_users.map(function (c_user) { return c_user.toLowerCase(); }).includes(lowerCase)) {
        console.log("The username ".concat(newusername, " is not available.please write different."));
    }
    else {
        console.log("The Username ".concat(newusername, " is availble"));
    }
});
